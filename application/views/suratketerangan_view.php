                            ...
                            <div class="col-md-10">
                              <input type="text" name="price_edit" id="price_edit" class="form-control" placeholder="Price">
												...
												<div class="form-group row">
														<label class="col-md-2 col-form-label">Username</label>
														<div class="col-md-10">
															<input type="text" name="user_name_edit" id="user_name_edit" class="form-control" placeholder="Price">
														</div>
												</div>
                  </div>
                  <div class="modal-footer">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function show_product(){
		    $.ajax({
		        type  : 'ajax',
		        url   : '<?php echo site_url('rubrik/rubrik_data')?>',
		        async : false,
		        dataType : 'json',
		        success : function(data){
		            ...
		            for(i=0; i<data.length; i++){
		                html += '<tr>'+
		                  		'<td>'+data[i].nama_rubrik+'</td>'+
		                        '<td>'+data[i].tgl_awal+'</td>'+
		                        '<td>'+data[i].tgl_akhir+'</td>'+
		                        '<td style="text-align:right;">'+
                                    '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-product_code="'+data[i].product_code+
																				'" data-product_name="'+data[i].product_name+
																				'" data-price="'+data[i].product_price+
																				'" data-user_name="'+ data[i].user_name +'">Edit</a>'+' '+
